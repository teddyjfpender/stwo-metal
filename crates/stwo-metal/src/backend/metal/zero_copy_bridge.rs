...
use crate::stwo_metal::base_field_vec::BaseFieldVec as MetalBaseFieldVec;
...
mod tests {
    ...
    fn zero_copy_round_trip_preserves_values() {
        ...
        let n: u32 = 256;
        let values: Vec<BaseField> = (0..n).map(|i| M31::from(i)).collect();
        ...
        let metal_eval: CircleEvaluation<
            crate::backend::metal::MetalBackend,
            BaseField,
            BitReversedOrder,
