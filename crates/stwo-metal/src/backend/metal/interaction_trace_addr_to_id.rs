...
/// Metal-native variant of [`gpu_gen_addr_to_id_interaction_trace`].
///
...
pub fn gpu_gen_addr_to_id_interaction_trace_metal(
    ids: &[Vec<PackedBaseField>],
    multiplicities: &[Vec<PackedBaseField>],
    lookup_elements: &InteractionLookupElements,
    relation_id: u32,
...
> {
    ...
    // Non-prefix-sum columns: zero-copy from GPU buffer.
    ...
    // Last column: read back for prefix-sum finalization, then re-upload.
    {
