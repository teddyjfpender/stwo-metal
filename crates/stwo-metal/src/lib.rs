...
pub mod program {
    ...
    pub use crate::backend::metal::{
        ...
        lower_registered_metal_evaluation_program_v1, lower_virtual_snos_evaluation_program_v1,
        lower_wide_fibonacci_evaluation_program_v1, metal_evaluation_program_overlays_v1,
        metal_evaluation_program_semantic_hash_v1,
        ...
        MetalEvaluationProgramLoweringError, MetalEvaluationProgramOverlayV1,
