...
const METAL_SOURCES: &[&str] = &[
    ...
    "interaction_trace_fused_opcodes",
];
...
fn main() {
    ...
    println!("cargo:rerun-if-changed=metal/interaction_trace_generic.metal");
    ...
    println!("cargo:rerun-if-changed=metal/interaction_trace_fused_opcodes.metal");
    for var in [
        CUDA_MODE_VAR,
        METAL_MODE_VAR,
        "CUDA_LIB_DIR",
